  ...
  const prepareInvoiceData = (): InvoiceData => {
    ...
    return {
      ...
      formData: {
        ...
        referenciaPagamento: formData.tipo === 'recibo' ? sanitizeString(safeFormData.referenciaPagamento || '') : safeFormData.referenciaPagamento,
        documentoAssociadoCustom: formData.tipo === 'recibo' ? sanitizeString(safeFormData.documentoAssociadoCustom || '') : undefined,
